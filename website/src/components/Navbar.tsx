...
export function Navbar({ variant = 'patient' }: NavbarProps) {
  ...
  return (
    <nav className={`${colors[variant]} text-white shadow-lg`}>
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex items-center justify-between h-16">
          <div className="flex items-center gap-3">
            ...
            <span className="font-bold text-lg">MediTrack Pro</span>
          </div>
